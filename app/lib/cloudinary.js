...
exports.image = function(source, options) {
    ...
    if ("html_width" in options) {
        options.width = exports.utils.option_consume(options, "html_width");
    }

    if ("html_height" in options) {
        options.height = exports.utils.option_consume(options, "html_height");
    }
